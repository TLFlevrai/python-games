...
class SnakeMenu:
    ...
    def __init__(self, surface, input_manager):
        ...
        #initialisation d'un Layout centré
        ...
        #Ajout des elements
        self.titles_labe = self.ui_builder.add_label("SNAKE", font_size=72, color=Colors.WHITE)
        ...
        print("SNAKE_MENU initialisé avec UIBuilder")
