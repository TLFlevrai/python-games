...
from .menus import SnakeMenu, SnakeSettings
...
class SnakeScreen:
    ...
    def __init__(self, surface, input_manager):
        ...
        self.menu = SnakeMenu(self.surface, self.input)
        self.settings = SnakeSettings(self.surface, self.input)
        self.game = SnakeGame(self.surface, self.input)
