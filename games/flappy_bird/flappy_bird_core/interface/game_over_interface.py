...
class GameOverInterface:
    ...
    Affiche le score final + boutons RESTART et MENU.
    """
    ...
    def draw(self, surface, score):
        ...
        pygame.draw.rect(
            panel_surf,
            (180, 50, 40, 200),       # Bordure rouge sobre pour game over
            pygame.Rect(0, 0, self.panel_width, self.panel_height),
            width=1,
            border_radius=16
        )
        ...
        # ---------- TEXTES STYLE CODE ----------
        title_text = self.font_title.render("game_over", True, (180, 70, 60))
        surface.blit(title_text, (self.panel_x + 16, self.panel_y + 14))

        score_text = self.font_score.render(f"score: {score}", True, (140, 140, 145))
